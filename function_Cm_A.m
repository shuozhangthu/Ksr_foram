...
function [o, time, out]=function_Cm_A(depth,pH,DIC,Temp,K_AB,K_MB,K_hco3)
...
%Set parameters
o.FAlk = 0.95e-5;%1.2e-6;%1e-6;              %moles/m2/s
o.fCa = 0;
o.tau = 1;%230;                %s
o.Dcell = 0;        %m/s
o.z = 10e-6;                %m
...
for i=1:20
    ...
    y0=4*2*h*h*a_new*alpha/boltz/TK/sigma;
    Rnet2=rho*u_net*h*b_new*d_new/2/y0;
